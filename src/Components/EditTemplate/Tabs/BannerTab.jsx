  ...
  const toggleCampaignActive = async (id) => {
    ...
    try {
        ...
        fetch(
          "https://email-signature-ewasbjbvendvfwck.canadacentral-01.azurewebsites.net/api/banners",
          {
            ...
            headers: {
              "Content-Type": "application/json",
              Cookie:
                "ARRAffinity=d8e9b80b64bf4b8d6f35de201a95cef0d730cbf1e6617cf235119fd987f06b94; ARRAffinitySameSite=d8e9b80b64bf4b8d6f35de201a95cef0d730cbf1e6617cf235119fd987f06b94",
            },
            body: JSON.stringify({
              ...bannerData,
      ...
      if (!existingApiResponse.ok || !newApiResponse.ok) {
        throw new Error(
          "Failed to update banner status on one or more services"
        );
      }
