...
// // Preview Component (internal to this file)
// const StandardBannerPreview = ({ 
//   banner, 
//   companyName, 
//   isSelected, 
//   onClick 
...
//         isSelected={isSelected} // Pass the prop directly
//         onClick={() => onSelect(banner.id)}
//       />
//     );
//   }

//   // Otherwise return the full editor
//   return (
    ...
    try {
      ...
      const [existingApiResponse, newApiResponse] = await Promise.all([
        ...
        fetch('https://email-signature-ewasbjbvendvfwck.canadacentral-01.azurewebsites.net/api/banners', {
          method: newActiveState ? 'POST' : 'DELETE',
          headers: {
            'Content-Type': 'application/json',
