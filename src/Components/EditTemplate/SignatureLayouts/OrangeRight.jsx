...
const Orangeright = ({ formData, designStyle }) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* LEFT SECTION - Contact Info, Company, Location (Previously on the right) */}
          <div
            style={{
              display: "flex",
          ...
          {/* MIDDLE Section - Name, Title, Social Icons (3 per line) */}
          <div style={{ flex: 1 }}>
            {/* Name */}
            <div
              style={{
          ...
          {/* RIGHT SECTION - Profile Image (Previously on the left) */}
